...
if __name__ == "__main__":
  ...
  # options
  parser.add_argument('--images_root', default='/mnt/poplin/share/dataset/MSCOCO/', help='root location in which images are stored, to be prepended to file_path in input json')
