...
def parse_opt():
    ...
    parser.add_argument('--all_switch_end_dis', type=int, default=0)
    ...
    parser.add_argument('--selected_region_file', type=str, default='/mnt/poplin/share/dataset/MSCOCO/selected_region_info_88_08.json')
    parser.add_argument('--whole_att_flg', type=int, default=0)
    parser.add_argument('--baseline_concat', type=int, default=0)
    parser.add_argument('--sim_pred_type', type=int, default=-1)
    parser.add_argument('--new_dataset', type=int, default=0)
    # '/mnt/poplin/share/dataset/MSCOCO/simple_id_order_info_10_8000.json'
    # '/mnt/poplin/share/dataset/MSCOCO/simple_id_order_8000_8000.json'
...
def image_features_info(text):
    if opt.bu == 1:
        ...
        text += '--input_fc_dir /mnt/poplin/share/2018/nakamura_M1/self_sequential/data_old/cocotalk_fc ' \
                '--input_att_dir /mnt/workspace2019/nakamura/selfsequential/data/cocotalk_subset_att_larger '
    else:
...
def make_train_script(opt):
    ...
    text = 'python train.py ' \
           ...
           '--all_switch_end_dis ' + str(opt.all_switch_end_dis) + ' ' \
            '--all_switch_dis ' + str(opt.all_switch_dis) + ' '

    if opt.data == 'coco':
        text += '--input_json /mnt/poplin/share/dataset/MSCOCO/cocotalk_subset_mscoco_.json ' \
            '--input_label_h5 /mnt/poplin/share/dataset/MSCOCO/cocotalk_subset_mscoco__label.h5 '
    elif opt.weight_deterministic_flg == 8 or opt.weight_deterministic_flg == 9:
        text += '--input_json /mnt/poplin/share/dataset/MSCOCO/cocotalk_subset_vg_larger_addregions_more2area.json ' \
                '--input_label_h5 /mnt/poplin/share/dataset/MSCOCO/cocotalk_subset_vg_larger_label_all.h5 '
    else:
        if opt.new_dataset == 1:
            text += '--input_json /mnt/poplin/share/dataset/MSCOCO/cocotalk_subset_vg_larger_addregions.json ' \
                '--input_label_h5 /mnt/poplin/share/dataset/MSCOCO/cocotalk_subset_vg_larger_label_all_newlabels.h5 '
        elif opt.new_dataset == 2:
            # more than 3 gt
            text += '--input_json /mnt/poplin/share/dataset/MSCOCO/cocotalk_subset_vg_larger_morethan3gt.json ' \
                    '--input_label_h5 /mnt/poplin/share/dataset/MSCOCO/cocotalk_subset_vg_larger_morethan3gt_label_all.h5 '
        else:
            text += '--input_json /mnt/poplin/share/dataset/MSCOCO/cocotalk_subset_vg_larger_addregions.json ' \
                    '--input_label_h5 /mnt/poplin/share/dataset/MSCOCO/cocotalk_subset_vg_larger_label_all.h5 '

    if opt.sim_pred_type > -1:
        text += '--sim_pred_type ' + str(opt.sim_pred_type) + ' '
...
def make_eval_script(opt):
    ...
    text = 'python eval.py ' \
           ...
           '--input_json /mnt/poplin/share/dataset/MSCOCO/cocotalk_subset_vg_larger_addregions_and_selected_id.json ' \
           '--beam_size 1 ' \
           '--dump_images 0 ' \
           '--language_eval 1 ' \
    ...
    if opt.use_region_similarity == 0:
        text += '--input_label_h5 /mnt/poplin/share/dataset/MSCOCO/cocotalk_subset_' + data_ + '__label.h5 '
    else:
        text += '--input_label_h5 /mnt/poplin/share/dataset/MSCOCO/cocotalk_subset_' + data_ + '_larger_label_all.h5 '
